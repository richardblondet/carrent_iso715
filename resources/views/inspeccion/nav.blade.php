...
<div class="col-12 masonry-item">
	...
	<nav class="navbar navbar-expand-lg navbar-light iso-nav">
		 <a class="navbar-brand">Inspecciones</a>

		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				@if( Request::route()->getName() != 'inspeccion.index' )
				<li class="nav-item active">
					<a class="nav-link" href="{{ route('inspeccion.index') }}">Ver todos</a>
				</li>
				@endif
				@if( Request::route()->getName() == 'inspeccion.index' )
				<li class="nav-item">
			    	<a href="{{ route('inspeccion.create') }}" class="btn btn-outline-success">
