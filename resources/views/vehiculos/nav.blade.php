	...
	<nav class="navbar navbar-expand-lg navbar-light iso-nav">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ml-auto">
				@if( Request::route()->getName() != 'vehiculos.index' )
				<li class="nav-item active">
					<a class="nav-link" href="{{ route('vehiculos.index') }}">Ver todos</a>
				</li>
				@endif
				@if( Request::route()->getName() == 'vehiculos.index' )
				<li class="nav-item">
			    	<a href="{{ route('vehiculos.create') }}" class="btn btn-outline-success">
